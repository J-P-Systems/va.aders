...
* ^status = #draft
* outcome.coding ^slicing.discriminator.type = #pattern
* outcome.coding ^slicing.discriminator.path = "$this"
* outcome.coding ^slicing.rules = #open
* outcome.coding contains va-outcome1 0..1 and va-outcome2 0..1 and va-outcome3 0..1 and va-outcome8 0..1 and va-outcome9 0..1 and va-outcome10 0..1 and va-outcome-13 0..1 and va-outcome11 0..1 and va-outcome12 0..1
* subject and actuality and date and event.coding and outcome.coding[va-outcome1] and outcome.coding[va-outcome2] and outcome.coding[va-outcome3] and outcome.coding[va-outcome8] and outcome.coding[va-outcome9] and outcome.coding[va-outcome10] and outcome.coding[va-outcome-13] and outcome.coding[va-outcome11] and outcome.coding[va-outcome12] and suspectEntity.instance MS
...
* outcome.coding[va-outcome10] -> "1915: source value from ADERS - 21_Dis case A"
* outcome.coding[va-outcome-13] -> "1916: source value from ADERS - 21_Death"
